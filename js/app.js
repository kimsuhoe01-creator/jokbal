...
const I18N = {
  ko:{storeName:'족발신선생 박닌점',call:'전화 주문',delivery:'DeliveryK 배달',priceNote:'가격은 VND 기준이며 POS/영수증 가격과 동일합니다.',detail:'자세히 보기',close:'접기',hall:'홀 식사',hallBenefit:'무료 서비스 3종 제공',takeaway:'배달 · 포장',takeBenefit:'족발볶음밥 + 막국수 서비스',people:'추천인원',photoReady:'사진 준비중',recommend:'추천',main:'메인',half:'반반',solo:'1인',side:'사이드',meal:'식사·탕',drink:'주류·음료',single:'가격',s:'소',m:'중',l:'대'},
  vi:{storeName:'Jokbal Sin Seon Saeng Bắc Ninh',call:'Gọi đặt món',delivery:'Đặt DeliveryK',priceNote:'Giá tính bằng VND và trùng với giá POS/hóa đơn.',detail:'Xem thêm',close:'Thu gọn',hall:'Ăn tại quán',hallBenefit:'Tặng 3 món miễn phí',takeaway:'Giao hàng · Mang về',takeBenefit:'Tặng cơm rang chân giò + mỳ trộn',people:'Khẩu phần gợi ý',photoReady:'Đang chuẩn bị ảnh',recommend:'Gợi ý',main:'Món chính',half:'2 món',solo:'1 người',side:'Món phụ',meal:'Cơm · Canh',drink:'Đồ uống',single:'Giá',s:'Nhỏ',m:'Vừa',l:'Lớn'},
  en:{storeName:'Jokbal Sin Seon Saeng Bac Ninh',call:'Call',delivery:'DeliveryK',priceNote:'Prices are in VND and match POS/receipt prices.',detail:'More details',close:'Close',hall:'Dine-in',hallBenefit:'3 free service items included',takeaway:'Delivery · Takeaway',takeBenefit:'Jokbal fried rice + spicy noodles included',people:'Recommended serving',photoReady:'Photo coming soon',recommend:'Recommended',main:'Mains',half:'Half & Half',solo:'For One',side:'Sides',meal:'Meals · Soups',drink:'Drinks',single:'Price',s:'S',m:'M',l:'L'},
  zh:{storeName:'猪蹄新先生 北宁店',call:'电话订餐',delivery:'DeliveryK 外卖',priceNote:'价格单位为VND，与POS/小票价格一致。',detail:'查看详情',close:'收起',hall:'堂食',hallBenefit:'赠送3种免费小菜',takeaway:'外卖 · 打包',takeBenefit:'赠送猪蹄炒饭 + 拌面',people:'建议人数',photoReady:'照片准备中',recommend:'推荐',main:'主菜',half:'双拼',solo:'单人餐',side:'配菜',meal:'饭 · 汤',drink:'酒水饮料',single:'价格',s:'小',m:'中',l:'大'}
};

const CATS = ['recommend','main','half','solo','side','meal','drink'];
const mainBenefitCats = ['recommend','main','half'];

const MENU = [
  {cat:'recommend', best:true, img:'images/half-oven.jpg', n:{ko:'화덕 반반메뉴',vi:'Set 2 món đút lò',en:'Oven Half & Half Platter',zh:'烤炉双拼'}, alt:{ko:'족발·보쌈·매운족발·냉채족발·매운보쌈 중 2가지 선택',vi:'Chọn 2 món trong chân giò, ba chỉ, chân giò cay, chân giò sốt mù tạt, ba chỉ cay',en:'Choose 2 items from jokbal, bossam, spicy jokbal, cold jokbal, spicy bossam',zh:'猪蹄、菜包肉、辣猪蹄、凉拌猪蹄、辣五花肉中任选2种'}, prices:[['m',tax8(880000)],['l',tax8(980000)]], people:{ko:'중 2~3인 / 대 3~4인',vi:'Vừa 2~3 người / Lớn 3~4 người',en:'M 2–3 people / L 3–4 people',zh:'中 2~3人 / 大 3~4人'}},
  ...
  {cat:'half', img:'images/half.jpg', best:true, n:{ko:'반반메뉴',vi:'Set 2 món',en:'Half & Half Platter',zh:'双拼拼盘'}, alt:{ko:'족발·보쌈·매운족발·냉채족발·매운보쌈 중 2가지 선택',vi:'Chọn 2 món',en:'Choose 2 items',zh:'任选2种'}, prices:[['m',tax8(880000)],['l',tax8(980000)]], people:{ko:'중 2~3인 / 대 3~4인',vi:'Vừa 2~3 người / Lớn 3~4 người',en:'M 2–3 / L 3–4',zh:'中2~3人 / 大3~4人'}},

  {cat:'solo', img:'images/solo-oven-jokbal.jpg', n:{ko:'화덕족발 (1인)',vi:'Chân giò đút lò (1 người)',en:'Oven Jokbal (For One)',zh:'烤炉猪蹄(单人)'}, prices:[['single',tax8(250000)]]},
  {cat:'solo', img:'images/solo-oven-bossam.jpg', n:{ko:'화덕보쌈 (1인)',vi:'Ba chỉ đút lò (1 người)',en:'Oven Bossam (For One)',zh:'烤炉五花肉(单人)'}, prices:[['single',tax8(250000)]]},
  {cat:'solo', img:'images/solo-spicy-jokbal.jpg', spicy:true, n:{ko:'매운족발 (1인)',vi:'Chân giò cay (1 người)',en:'Spicy Jokbal (For One)',zh:'辣烤猪蹄(单人)'}, prices:[['single',tax8(270000)]]},
  {cat:'solo', img:'images/solo-cold-jokbal.jpg', n:{ko:'냉채족발 (1인)',vi:'Chân giò sốt mù tạt (1 người)',en:'Cold Jokbal (For One)',zh:'凉拌猪蹄(单人)'}, prices:[['single',tax8(270000)]]},
  {cat:'solo', img:'images/solo-spicy-bossam.jpg', spicy:true, n:{ko:'매운보쌈 (1인)',vi:'Ba chỉ cay (1 người)',en:'Spicy Bossam (For One)',zh:'辣五花肉(单人)'}, prices:[['single',tax8(270000)]]},
  ...
  {cat:'meal', img:'images/bone-soup.jpg', n:{ko:'뼈해장국',vi:'Canh xương hầm',en:'Pork-Bone Soup',zh:'骨头汤'}, alt:{ko:'매일 매장에서 직접 끓입니다',vi:'Hầm trực tiếp tại quán mỗi ngày',en:'Simmered in-house daily',zh:'每日店内现熬'}, prices:[['single',tax8(160000)]]},
...
$('#changeLang').addEventListener('click', showLang);
...
function renderMenu(){
  ...
  CATS.forEach(cat => {
    ...
    const h = document.createElement('h2'); h.className = 'section-title'; h.id = 'sec-' + cat; h.textContent = t(cat); menuEl.appendChild(h);
    items.forEach((item) => menuEl.appendChild(card(item)));
  });
  observeSections();
}
function card(item){
  ...
  el.innerHTML = `
    <div class="photo-wrap" role="button" tabindex="0" aria-label="open photo">
      <img src="${item.img}" alt="${item.n[lang] || item.n.ko}" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'">
      <div class="placeholder" style="display:none">${t('photoReady')}</div>
  ...
  el.querySelector('.photo-wrap').onclick = () => openPhoto(item);
  el.querySelector('.photo-wrap').onkeydown = e => { if(e.key === 'Enter') openPhoto(item); };
  return el;
}
